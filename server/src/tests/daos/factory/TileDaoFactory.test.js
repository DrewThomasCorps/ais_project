...
describe('TileDaoFactory', function () {
    ...
    describe('getTileDoa()', function () {
        it('should throw an exception for undefined config', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            chai_1.expect(error_1.message).to.be.equal('undefined is not a valid database type.');
                            chai_1.expect(error_1.name).to.be.equal('InvalidDatabaseConfigException');
                            return [3 /*break*/, 3];
