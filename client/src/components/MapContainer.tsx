...
const MapContainer = () => {
    ...
    const [images] = useState([
        {"id": 1, "ICESName": "-1", "west": 7.0, "south": 54.5, "east": 13.0, "north": 57.5, "scale": 1, "filename": "ROOT.png", "image_width": 2000, "image_height": 2000, "image_west": 7.0, "image_south": 54.31614, "image_east": 13.0, "image_north": 57.669343, "contained_by": -1},
    ...
    const handleClick = (e: { preventDefault: () => void; clientX: number; clientY: number;}) => {
        e.preventDefault();
    ...
    const calculateMapX = (e: any): number => {
        ...
        return currentImage.west + (currentImage.east - currentImage.west) * ((e.clientX - divLeft) / divWidth);
    }
    ...
    const calculateMapY = (e: any): number => {
        ...
        return currentImage.south + (currentImage.north - currentImage.south) * (1 - ((e.clientY - divTop) / divHeight));
    }
